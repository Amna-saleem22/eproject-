...
//       <div style={{ background: "#2c2c3e", padding: "30px", borderRadius: "10px", width: "100%", maxWidth: "400px" }}>
//         <h2 style={{ textAlign: "center", color: "#00e676", marginBottom: "20px" }}>💳 Payment</h2>
//         <h3 style={{ textAlign: "center", color: "#00e676" }}>Total Amount: Rs {booking.totalAmount}</h3>

//         <div style={{ marginBottom: "15px" }}>
//           <label>Payment Method:</label>
//           <select value={method} onChange={(e) => setMethod(e.target.value)} style={{ width:"100%", padding:"10px", borderRadius:"5px", marginTop:"5px", backgroundColor:"#1e1e2f", color:"#f5f5f5", border:"1px solid #444" }}>
//             <option value="Online">Online</option>
//             <option value="Cash">Cash</option>
//           </select>
//         </div>

//         {method === "Online" && ["customerName","email","nameOnCard","cardNumber","expiry","cvv"].map((field) => (
//           <div key={field} style={{ marginBottom: "10px" }}>
//             <input
//               type={field==="cvv"?"password":"text"}
//               placeholder={field==="cvv"?"CVV":field.replace(/([A-Z])/g, ' $1')}
//               name={field}
...
//             />
//             {errors[field] && <p style={{ color:"#ff5252", fontSize:"13px", margin:"5px 0 0 0" }}>{errors[field]}</p>}
//           </div>
//         ))}

//         <button onClick={payNow} style={{ width:"100%", padding:"12px", backgroundColor:"#00e676", color:"#1e1e2f", fontWeight:"bold", fontSize:"16px", border:"none", borderRadius:"5px", cursor:"pointer" }}>
