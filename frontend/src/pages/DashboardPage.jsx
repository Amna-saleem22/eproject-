    ...
    return (
      ...
      >
        <motion.div animate={{ rotate: 360 }} transition={{ duration: 2, repeat: Infinity }}>
          <DashboardIcon sx={{ fontSize: 60, color: COLORS.primary }} />
        </motion.div>
      </Box>
    );
  }
    ...
    >
      <Container maxWidth={CONTAINER.content}>
        ...
        <Box sx={{ textAlign: "center", mb: SPACING.sectionTitleBottom }}>
          ...
          <Typography variant="h3" sx={{ color: COLORS.text, fontWeight: 600 }}>
            User Dashboard
          </Typography>
        ...
        {/* Bookings */}
        {bookings.length === 0 ? (
          <Paper sx={{ p: SPACING.cardPadding, textAlign: "center" }}>
            <Typography variant="h5" sx={{ mb: 1 }}>
              No Active Bookings
            </Typography>
            <Typography variant="body1" sx={{ mb: 2 }}>
              Start planning your luxury stay today!
            </Typography>
          ...
          <Grid container spacing={SPACING.formFieldGap}>
            {bookings.map((booking) => (
              <Grid item xs={12} key={booking._id}>
                <Card sx={{ background: COLORS.backgroundElevated, borderRadius: 2 }}>
                  <CardContent>
                    ...
                    <Grid container spacing={2} sx={{ mb: 2 }}>
                      ...
                      {booking.phone && (
                        <Grid item xs={12} sm={6}>
                          <PhoneIcon sx={{ fontSize: 16, mr: 0.5, color: "#1976d2" }} />
                          <Typography variant="body2" sx={{ color: "white", display: "inline" }}>
                            {booking.phone}
                          </Typography>
                        </Grid>
